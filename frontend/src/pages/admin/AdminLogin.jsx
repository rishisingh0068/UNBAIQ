...
const AdminLogin = () => {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f3f7fa] px-3 py-6 font-lexend sm:px-5 sm:py-12">
      {/* Compact phone padding expands into the existing desktop login card. */}
      <section className="w-full max-w-[430px] rounded-[16px] border border-[#dce7ef] bg-white p-5 shadow-[0_24px_70px_rgba(6,61,107,0.12)] sm:rounded-[18px] sm:p-9">
        <NavLink
          to="/"
        ...
        <div className="mt-8">
          ...
          <h1 className="mt-2 text-[26px] font-semibold tracking-[-0.03em] text-[#063d6b] sm:text-[30px]">
            Welcome back
          </h1>
