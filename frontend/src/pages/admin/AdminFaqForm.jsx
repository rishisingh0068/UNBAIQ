...
const AdminFaqForm = () => {
  ...
  return <section className="mx-auto max-w-5xl">
    ...
    <form onSubmit={handleSubmit} className="mt-7 rounded-xl border border-[#dce5ec] bg-white p-6 shadow-sm sm:p-8">
      ...
      <div className="mt-6 flex justify-end"><button type="submit" disabled={isSaving} className="inline-flex items-center gap-2 rounded-lg bg-[#063d6b] px-5 py-3 text-sm font-semibold text-white disabled:opacity-60"><Save size={17} /> {isSaving ? "Saving..." : "Save FAQ"}</button></div>
    </form>
  </section>;
};
