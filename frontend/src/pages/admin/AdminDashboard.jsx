...
const AdminDashboard = () => {
  ...
  return <section className="mx-auto max-w-[1500px]">
    <div className="mb-7 rounded-xl border border-[#dce5ec] bg-gradient-to-r from-white to-[#f3f8fb] px-6 py-5 shadow-[0_6px_22px_rgba(32,45,58,0.05)]"><p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#8496a5]">Admin workspace</p><h2 className="mt-1 text-2xl font-semibold text-[#063d6b]">Dashboard Overview</h2><p className="mt-1 text-sm text-[#667d90]">Monitor enquiries and all website content from one place.</p></div>
    ...
    <section className="mt-8 overflow-hidden rounded-xl border border-[#dce5ec] bg-white shadow-[0_8px_28px_rgba(32,45,58,0.06)]">
      <header className="flex items-center justify-between border-b border-[#e6edf2] bg-gradient-to-r from-white to-[#f7fafc] px-6 py-5"><div><h3 className="font-semibold text-[#063d6b]">Recent enquiries</h3><p className="mt-1 text-xs text-[#8496a5]">Latest messages from the website</p></div><NavLink to="/admin/enquiries" className="rounded-lg bg-[#e9f4fa] px-3 py-2 text-xs font-semibold text-[#176b98] transition hover:bg-[#dceef6]">View all</NavLink></header>
      {recentEnquiries.length === 0 ? <p className="p-8 text-center text-sm text-[#8496a5]">No enquiries have arrived yet.</p> : <div className="overflow-x-auto"><table className="w-full min-w-[680px] text-left text-sm">
